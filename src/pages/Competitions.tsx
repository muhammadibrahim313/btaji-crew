      ...
      <div className="container relative">
        ...
        >
          ...
          <p className="text-muted-foreground text-lg mb-12">
            All the AI/ML competitions and Kaggle challenges hosted and participated in by BTAJI CREW.
          </p>

          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {["Kaggle Challenges", "University Contests", "Open Competitions"].map((title, i) => (
              <motion.div
                key={title}
